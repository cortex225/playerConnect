...
export default function MessagesPage() {
  ...
  useEffect(() => {
    ...
    fetch("/api/social/activity")
      ...
      .then((data) => {
        ...
        setUnreadCount(0); // Marked as read by API
      })
      .catch(() => setActivities([]))
  ...
  const getActivityIcon = (type: string) => {
    switch (type) {
      ...
      case "RECRUITER_VIEW": return <Bell className="size-4 text-yellow-500" />;
  ...
  const getActivityText = (activity: Activity) => {
    switch (activity.type) {
      case "LIKE": return "a aime ta video";
      case "COMMENT": return "a commente ta video";
      case "FOLLOW": return "a commence a te suivre";
      case "RECRUITER_VIEW": return "a consulte ton profil";
      case "VIEW_PROFILE": return "a visite ton profil";
      default: return "a interagi avec ton contenu";
    }
  };
            ...
            {loadingActivities ? (
              ...
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <p className="mt-1 max-w-xs text-sm text-muted-foreground">
                  Les likes, commentaires et nouveaux abonnes apparaitront ici
                </p>
              </div>
            ) : (
